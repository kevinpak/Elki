...
<div class="container float-center">
	...
	<div class="information">
		<div class="row large-collapse medium-collapse small-collapse "><div class="columns large-12 small-11 medium-11 text-center small-centered large-centered medium-centered"><h2>Самые дешевые ели в САНКТ-ПЕТЕРБУРГЕ <span>с бесплатной доставкой!</span></h2></div></div>
		<div class="row">
			...
			<div class="columns large-4 small-12 medium-8">
				<div class="row">
					...
					<div class="row">
						...
						<div class="row">
							...
							<div class="row">
								<div class="columns large-8 small-12 medium-12"><div class="info-text" style="margin: -20px 0px 0px -10px; width: 370px;"><div class="snowflake"></div><h6><big class="esp">20%</big> &mdash; такая скидка действует в нашем магазине в предпраздничное <br>время!</h6></div></div>
							</div>
						</div>
				...
				<div class="take-tree">
					...
					if (isset($_POST['by_elki_ldg'])){	
						extract($_POST);	
						$city ="санкт петербург";
						if($name_client&&$phone_client&&$prodoct&&$city){
							addcommande_ldgM($name_client,$phone_client,$prodoct,$city);
									//echo "Success";
							include('sms/sms_commande.php');
							header("location:http://elkyzelenye24.ru/msk_20");
						}
					}

							//form fix
					if (isset($_POST['by_elki_ldg2'])){	
						extract($_POST);	
						$city ="санкт петербург";
						$prodoct="Не выбран";
						if($name_client&&$phone_client&&$prodoct&&$city){
							...
							//reduction
					if (isset($_POST['obtenir_redu'])){	
						extract($_POST);	
						$city ="санкт петербург";
						$code="20%";
						if($phone_client&&$name_client&&$city&&$code){
							include('sms/sms_reduction.php');
							header("location:http://elkyzelenye24.ru/msk_20");
							echo "Success";
						}
						echo"<div class='success_mesage'>Pseaudo ou password incorrect</div>";
					}
