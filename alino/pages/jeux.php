...
<?php include('functions/pagination_jeux.func.php'); ?>
							...
							<div class="z_pb">
								...
								<div class="z_info_pb">
									...
									<p class="taille_product">
										<small> ДЛИНА: '.$data['longueur'].' СМ</small> 
										<a href="index.php?page=dev_prod_jeux&&id_el='.$data['id_jeux'].'"> Подробнее...</a>
									</p>
								...
								<div class="z_commande_pb">
									...
									<div class="z_commande_pb_quantite z_cpb">
										...
										<div class="z_commande_pb_btn z_cpb">
											<a href="'.$data['id_jeux'].'"  class="cache_inf">
												<input type="text" name="prodt" value="'.$data['id_jeux'].'">
											</a>
											<button class="z_cpb_btn" name="z_cpb_btn_jeux">В корзину</button>
										</div>
									</form>
								</div>
							</div>
